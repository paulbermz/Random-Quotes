...
document.addEventListener("DOMContentLoaded", function () {
    const quotes = {
        ...
        { text: "The good life is one inspired by love and guided by knowledge.", author: "Bertrand" },
        ...
        love: [ 
         ...
         { text: "The best thing to hold onto in life is each other.", author: "Audre Lorde" },
         ...
         { text: "To love someone is to see a miracle invisible to others.", author: "Francois Mauriac" },
         ...
         { text: "In love there are two things: bodies and words.", author: "Joyce Carol Oates" },
         ...
         { text: "If you find someone you love in your life, then hang on to that love.", author: "Princess Diana" },
         ...
         { text: "A flower cannot blossom without sunshine, and man cannot live without love.", author: "Max Muller" },
         { text: "Love is the only reality, and it is not a mere sentiment. It is the ultimate truth that lies at the heart of creation.", author: "Rabindranath Tagore" },
        ...
        { text: "If you are changing the world, you are working on important things. You are excited to get up in the morning.", author: "Larry Page" },
        { text: "Obviously everyone wants to be successful, but I want to be looked back on as being very innovative, very trusted and ethical.", author: "Sergey Brin" },
        ...
        { text: "It’s very hard to fail completely if you aim high enough.", author: "Larry Page" },
        ...
        { text: "Solving big problems is easier than solving little problems.", author: "Sergey Brin" },
        { text: "The biggest risk is not taking any risk.", author: "Mark Zuckerberg" },
        { text: "Believe you can and you're halfway there.", author: "Theodore Roosevelt" },
        { text: "We want Google to be the third half of your brain.", author: "Sergey Brin" },
        ...
        { text: "Don't be distracted by criticism. Remember—the only taste of success some people have is when they take a bite out of you.", author: "Zig Ziglar" },
        { text: "The only place where success comes before work is in the dictionary.", author: "Vidal Sassoon" },
        ...
        { text: "It is better to die fighting than to live without freedom.", author: "General Antonio Luna" },
        { text: "I die without seeing the dawn brighten over my native land. You who have it to see, welcome it—and forget not those who have fallen during the night!", author: "José Rizal" },
        { text: "True love of country is not a matter of empty words and expressions; it is shown through deeds and sacrifices.", author: "Emilio Aguinaldo" },
        { text: "To die because of you.", author: "Lupang Hinirang" },
        { text: "He who does not know how to look back at where he came from will never get to his destination.", author: "José Rizal" },
        { text: "For the salvation of the people, we need an army that is disciplined, hardworking, and ready to sacrifice its life.", author: "General Antonio Luna" },
        { text: "I want to show my countrymen that I am a man who cannot be intimidated by anyone.", author: "Andres Bonifacio" },
        { text: "It is a useless life that is not consecrated to a great ideal. It is like a stone wasted on the field without becoming a part of any edifice.", author: "José Rizal" },
        { text: "I would rather have a government run like hell by Filipinos than a government run like heaven by Americans.", author: "Manuel L. Quezon" },
        { text: "Let us be more noble in everything. Let us not be cowards nor traitors nor scoundrels as others have been, but let us be good, and, above all, be true.", author: "José Rizal" },
        ...
        { text: "Freedom is not demanded, but fought for.", author: "General Antonio Luna" },
        ...
        { text: "For every soldier who walks, another hero lies.", author: "General Antonio Luna" }, 
        { text: "The tree of liberty must be refreshed from time to time with the blood of patriots and tyrants.", author: "Thomas Jefferson" },
        { text: "My fellow Americans, ask not what your country can do for you, ask what you can do for your country.", author: "John F. Kennedy" },
        { text: "Those who deny freedom to others deserve it not for themselves.", author: "Abraham Lincoln" },
        { text: "If we don't stand up now, when?", author: "General Antonio Luna" },
        { text: "Liberty, when it begins to take root, is a plant of rapid growth.", author: "George Washington" },
        { text: "The wounded hero, as he fights, he is expected to rise again.", author: "General Antonio Luna" },
        { text: "A man may die, nations may rise and fall, but an idea lives on.", author: "John F. Kennedy" },
        { text: "The Philippines is for Filipinos!", author: "General Antonio Luna" },
        { text: "Where liberty dwells, there is my country.", author: "Benjamin Franklin" },
        { text: "Patriotism is the last refuge of the scoundrel.", author: "Samuel Johnson" },
        { text: "In the face of impossible odds, people who love this country can change it.", author: "Barack Obama" },
        { text: "The love of one's country is a splendid thing. But why should love stop at the border?", author: "Pablo Casals" },
        { text: "I am not an Athenian or a Greek, but a citizen of the world.", author: "Socrates" },
        { text: "We cannot win if we are not united.", author: "General Antonio Luna" },
        { text: "I only regret that I have but one life to lose for my country.", author: "Nathan Hale" },
        { text: "We need a type of patriotism that recognizes the virtues of those who are opposed to us.", author: "Francis John McConnell" },
        ...
        { text: "This nation will remain the land of the free only so long as it is the home of the brave.", author: "Elmer Davis" },
        { text: "To survive in peace and harmony, united and strong, we must have one people, one nation, one flag.", author: "Pauline Hanson" },
        { text: "We shall fight on the beaches, we shall fight on the landing grounds, we shall fight in the fields and in the streets, we shall fight in the hills; we shall never surrender.", author: "Winston Churchill" },
        { text: "The price of greatness is responsibility.", author: "Winston Churchill" },
        { text: "Discipline is the soul of the army.", author: "General Antonio Luna" },
        { text: "I have nothing to offer but blood, toil, tears, and sweat.", author: "Winston Churchill" },
        { text: "Patriotism is not enough. I must have no hatred or bitterness towards anyone.", author: "Edith Cavell" },
        { text: "To die for the people is as holy as to die for God.", author: "General Antonio Luna" },
        { text: "God save the Queen!", author: "Traditional British Patriotic Song" },
        { text: "The more we sweat in peace, the less we bleed in war.", author: "Vince Lombardi" },
        { text: "This blessed plot, this earth, this realm, this England.", author: "William Shakespeare" },
        { text: "If we are together nothing is impossible. If we are divided all will fail.", author: "Winston Churchill" },
        { text: "We make a living by what we get, but we make a life by what we give.", author: "Winston Churchill" },
        { text: "Freedom is the sure possession of those alone who have the courage to defend it.", author: "Pericles (adapted by Winston Churchill)" },
        ...
        { text: "It is blood alone that can pay the price of freedom. Give me blood and I will give you freedom!", author: "Subhas Chandra Bose" },
        ...
        { text: "I dream of an Africa which is in peace with itself.", author: "Nelson Mandela" },
        ...
        { text: "The struggle is my life. I will continue fighting for freedom until the end of my days.", author: "Nelson Mandela" },
        { text: "It is better to lead from behind and to put others in front, especially when you celebrate victory when nice things occur.", author: "Nelson Mandela" },
        ...
        { text: "France has lost a battle. But France has not lost the war.", author: "Charles de Gaulle" },
        { text: "Patriotism is when love of your own people comes first; nationalism, when hate for people other than your own comes first.", author: "Charles de Gaulle" },
        { text: "To be free is to live a life that respects and enhances the freedom of others.", author: "Charles de Gaulle" },
        { text: "Victory belongs to the most persevering.", author: "Napoleon Bonaparte" },
        { text: "France cannot be France without greatness.", author: "Charles de Gaulle" },
        { text: "Men are moved by two levers only: fear and self-interest.", author: "Napoleon Bonaparte" },
        { text: "The human race is a single family. And unless we learn to live together as brothers, we shall all perish together as fools.", author: "Albert Einstein (often quoted in France)" },
        { text: "The battle of France is over. I expect that the battle of Britain is about to begin.", author: "Winston Churchill (often quoted in France)" },    
        { text: "Let France have good mothers, and she will have good sons.", author: "Napoleon Bonaparte" },
        { text: "Patriotism means to stand by the country. It does not mean to stand by the president.", author: "Vladimir Putin" },
    ],
        ...
        { text: "Emotion is the fuel for the passion in our life.", author: "Tony Robbins" },
        { text: "The only thing we have to fear is fear itself.", author: "Franklin D. Roosevelt" },
        { text: "In the middle of every difficulty lies opportunity.", author: "Albert Einstein" },
        { text: "Emotion is a way of touching the essence of life.", author: "Shirley MacLaine" },
        { text: "The greatest glory in living lies not in never falling, but in rising every time we fall.", author: "Nelson Mandela" },
        { text: "You must do the things you think you cannot do.", author: "Eleanor Roosevelt" },
        { text: "It's not how we make mistakes, but how we correct them that defines us.", author: "Rachel Wolchin" },
        { text: "The only way to deal with this life meaningfully is to find one's passion and put everything into it.", author: "Richard Gere" },
        { text: "True love is not about perfection, it is hidden in flaws.", author: "Unknown" },
    ],
        ...
        { text: "You are my sun, my moon, and all my stars.", author: "e. e. cummings" },
        { text: "When I saw you I fell in love, and you smiled because you knew.", author: "Arrigo Boito" },
        { text: "To love or have loved, that is enough. Ask nothing further.", author: "Victor Hugo" },
        { text: "The heart has its reasons which reason knows not.", author: "Blaise Pascal" },
        ...
        { text: "You are my everything. Everything else is just something else.", author: "Kyle Borja" },
        ...
        { text: "When you are with me, the world is full of light.", author: "Berto" },
        { text: "I fell in love with you because you loved me when I couldn't love myself.", author: "Kyle Borja" },
        { text: "You make my heart smile.", author: "Unknown" },
        { text: "The first time I saw you, I knew I was going to love you forever.", author: "Deguito" },
        { text: "If I know what love is, it's because of you.", author: "Herman Hesse" },
        { text: "You are the one I want to spend my life with.", author: "Raul Robertson" },
        { text: "You are my today and all of my tomorrows.", author: "Leo Christopher" },
        { text: "Being in love with you makes every day feel like Valentine's Day.", author: "Unknown" },
        { text: "I loved you yesterday, I love you still, I always have and I always will.", author: "Unknown" },
    ],
...
$(document).ready(function () {
    ...
    $('#home-nav').on('click', function () {
        ...
        // Add any additional logic to return to the main home section here
    });
...
$('#prev-quote').on('click', function () {
    ...
    voiceCommandButton.addEventListener("click", function () {
        ...
        if (referrer.includes('facebook.com') || referrer.includes('messenger.com')) {
            showErrorModal('Voice command not supported on this app. Please open in a different browser for full functionality.');
        ...
        if ("SpeechRecognition" in window || "webkitSpeechRecognition" in window) {
            if (!isVoiceRecognitionOn) {
                ...
                recognition.onresult = function (event) {
                    ...
                    if (transcript.includes("next") || transcript.includes("sunod") || transcript.includes("proceed")) {
                        document.getElementById("new-quote").click();
                    } else if (transcript.includes("previous") || transcript.includes("prev") || transcript.includes("balik")) {
                        document.getElementById("prev-quote").click();
                    } else if (transcript.includes("read") || transcript.includes("basahabay") || transcript.includes("speak") || transcript.includes("basahinmo")) {
                        ...
                        const optionExists = [...document.getElementById("quote-type").options].some(
                            option => option.textContent.toLowerCase() === selectedCategory
                        );
                        if (optionExists) {
                            document.getElementById("quote-type").value = selectedCategory;
                            document.getElementById("quote-type").dispatchEvent(new Event("change"));
                        }
            ...
            showErrorModal('Voice recognition is not supported on this app. Please open in a different browser for full functionality.');
        }
    });
    ...
    if ('speechSynthesis' in window) {
        const speechSynthesisUtterance = new SpeechSynthesisUtterance(`${quote.text} ${quote.author}`);
   ...
   $('#voice-button').on('click', function () {
    ...
    if ('speechSynthesis' in window) {
        ...
        if (referrer.includes('facebook.com') || referrer.includes('messenger.com') || 
            ...
            showErrorModal('Speech synthesis not supported on this app. Please open in a different browser for full functionality.');
        } else {
            showErrorModal('Speech synthesis is not supported on this app.');
        }
    }
   ...
   $('#errorModal').on('hidden.bs.modal', function () {
    ...
    if (initialQuoteText === "" || initialQuoteText.toLowerCase() === "choose type of quotes." ||  initialQuoteText.toLowerCase() === "no quotes found." ) {
    ...
    $('#twitter-button').on('click', function () {
        ...
        if (quoteText === "" || quoteText.toLowerCase() === "no quotes found." || quoteText.toLowerCase() === "choose type of quotes.") {
   ...
   $('#copy-quote').on('click', function () {
    ...
    if (quoteText === "" || quoteText === "Choose a type of quotes." || quoteText.toLowerCase() === "no quotes found" ) {
    ...
    function fetchNewsUpdates() {
        $.get(apiUrl, function (data) {
            ...
            $('.read-more').on('click', function (e) {
                ...
                $(this).text($fullDescription.is(':visible') ? 'Read less' : 'Read more');
            });
        }).fail(function () {
            $('#news-updates').html('<p>Failed to load news updates. Please try again later.</p>');
        });
    }
...
$(document).ready(function () {
    ...
    function fetchWeatherData(lat, lon) {
        ...
        $.getJSON(apiUrl, function (data) {
            ...
            $('#weather-forecast').html("<p>Unable to fetch weather data. Please try again later.</p>");
        });
        ...
        $.getJSON(forecastUrl, function (forecastData) {
            ...
            $('#hourly-forecast').html("<p>Unable to fetch forecast data. Please try again later.</p>");
        });
    }
    ...
    function getLocation() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                $('#weather-forecast').html("<p>Unable to retrieve your location. Please allow location access and try again.</p>");
            });
        } else {
            $('#weather-forecast').html("<p>Geolocation is not supported by this browser.</p>");
        }
    }
